...
async function seedSampleData(userId) {
  ...
  try {
    ...
    console.log('💡 Creating social traits...');
    ...
    console.log('✅ Social traits created');

    // 4. CREATE SOCIAL SKILLS (using batch)
    console.log('🎯 Creating social skills...');
...
const skills = [
  ...
  { 
    ...
    maxXp: 1000,
    color: '#e879f9', 
    trend: [50, 58, 65, 72, 78, 85] 
  }
];

skills.forEach(skill => {
  const skillRef = doc(db, 'users', userId, 'skills', skill.id);  // CHANGED: removed 'socialSkills' and 'skills', use skill.id
  batch.set(skillRef, {
        ...skill,
        createdAt: serverTimestamp(),
        updatedAt: serverTimestamp()
    ...
    await batch.commit();
    console.log('✅ Social skills created');

    // 5. CREATE SOCIAL ACTIONS
    console.log('⚡ Creating social actions...');
    batch = writeBatch(db);
    ...
    await batch.commit();
    console.log('✅ Social actions created');
    ...
    console.log('\n🎉 SUCCESS! Sample data created for user:', userId);
    console.log('\n📋 Summary:');
    console.log('  ✓ User profile');
    console.log('  ✓ User stats');
    console.log('  ✓ 5 Social traits');
    console.log('  ✓ 4 Social skills');
    console.log('  ✓ 6 Social actions');
    console.log('  ✓ 5 Milestones');
    console.log('  ✓ 4 Challenges');
    console.log('  ✓ 2 Reflections');
    console.log('  ✓ User settings');
    console.log('\n✨ You can now log in and view your profile!\n');
...
console.log('╔══════════════════════════════════════╗');
console.log('║   Social Skills Sample Data Seeder   ║');
console.log('╚══════════════════════════════════════╝\n');
