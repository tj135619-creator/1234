      ...
      <div className="max-w-5xl mx-auto">
        ...
        {currentStep > 1 && (
          <div className="mt-8 flex justify-between">
            <button
              onClick={prevStep}
              className="px-6 py-3 bg-purple-800/50 hover:bg-purple-700/50 rounded-xl font-medium transition-all flex items-center gap-2"
            >
            ...
            {currentStep < 8 && (
              <button
                onClick={nextStep}
                className="px-6 py-3 bg-purple-600 hover:bg-purple-500 rounded-xl font-medium transition-all flex items-center gap-2"
              >
                Skip
